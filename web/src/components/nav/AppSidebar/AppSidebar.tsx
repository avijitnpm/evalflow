    ...
    <SidebarGroup className="border-b">
      ...
      <SidebarGroupContent>
        <SidebarMenu>
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild tooltip="Your EvalFlow Organizations">
              <Link href="/">
                <Grid2X2 className="h-4 w-4" />
                <span>Your EvalFlow Orgs</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
...
const VersionLabel = ({ state }: { state: SidebarVersionState }) => {
  ...
  return (
    <span
      className="h-5 max-w-full min-w-0 translate-y-0.5 py-0 text-[0.625rem] leading-none text-muted-foreground truncate"
      title={versionText}
    >
      {versionText}
    </span>
