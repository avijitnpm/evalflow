...
/**
 * Compact EvalFlow brand mark for the top bar.
 *
 ...
 *
 * `variant="icon"` (default) renders just the EvalFlow mark; `variant="wordmark"`
...
export const TopbarBrand = ({
  ...
  return (
    <Link
      href="/"
      aria-label="EvalFlow home"
      className={cn("flex shrink-0 items-center gap-1", className)}
    >
      {logoLight && logoDark ? (
        // Custom logo (max aspect ratio 1:3 per docs) + the EvalFlow mark,
