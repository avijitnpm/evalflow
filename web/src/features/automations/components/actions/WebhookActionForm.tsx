  ...
  headers: z.array(
    z.object({
      name: z.string().refine(
        ...
        {
          message:
            "This header is automatically added by EvalFlow and cannot be customized",
        },
      ),
      value: z.string(),
...
export const WebhookActionForm: React.FC<WebhookActionFormProps> = ({
  ...
  // Filter out headers managed by EvalFlow from the user-editable headers
      ...
      <div>
        ...
        <div className="mb-4">
          <FormDescription className="mb-2">
            Default headers (automatically added by EvalFlow):
          </FormDescription>
          {Object.entries({
            ...WebhookDefaultHeaders,
