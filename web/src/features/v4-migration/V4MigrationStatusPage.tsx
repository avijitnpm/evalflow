          ...
          <div className="text-muted-foreground flex flex-col gap-2 text-sm leading-relaxed">
            <p>
              {actionNeededProjects > 0
                ? "EvalFlow v4 is here: real-time ingestion and up to 165× faster queries. Complete the action items on each project below to avoid disruption. "
                : "EvalFlow v4 is here: real-time ingestion and up to 165× faster queries. "}
              <V4MigrationDocsLink />
            </p>
