                            ...
                            render={({ field }) => (
                              <div className="flex min-w-0 items-start gap-2">
                                <VariableMappingDescription
                                  title="Object"
                                  description="EvalFlow object to retrieve the data from."
                                  href="https://langfuse.com/docs/evaluation/evaluation-methods/llm-as-a-judge"
                                />
                              ...
                              render={({ field }) => {
                                ...
                                return (
                                  <div className="flex min-w-0 items-start gap-2">
                                    <VariableMappingDescription
                                      title="Object Name"
                                      description="Name of the EvalFlow object to retrieve the data from."
                                      href="https://langfuse.com/docs/evaluation/evaluation-methods/llm-as-a-judge"
                                    />
                                    <FormItem className="min-w-0 flex-1">
                                      <FormControl>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <div className="flex min-w-0 items-start gap-2">
                                <VariableMappingDescription
                                  title="Object Field"
                                  description="Field on the EvalFlow object to insert into the template."
                                  href="https://langfuse.com/docs/evaluation/evaluation-methods/llm-as-a-judge"
                                />
                                <FormItem className="min-w-0 flex-1">
                                  <FormControl>
