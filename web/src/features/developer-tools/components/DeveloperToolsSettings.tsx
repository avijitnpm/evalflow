...
export function DeveloperToolsSettings({ projectId }: { projectId: string }) {
  return (
    <div>
      ...
      <p className="text-muted-foreground mb-6 text-sm">
        Bring EvalFlow into your terminal and AI coding agents. These tools let
        you and your agents read and write EvalFlow data—traces, prompts,
      ...
      <div className="space-y-6">
        <Card className="p-4">
          ...
          <p className="text-primary mb-4 text-sm">
            The EvalFlow Agent Skill is an open-source skill following
            Anthropic&apos;s Agent Skills standard. It equips AI coding agents
            (Claude Code, Cursor, Windsurf) with native EvalFlow capabilities
        ...
        <Card className="p-4">
          ...
          <p className="text-primary mb-4 text-sm">
            The EvalFlow MCP server lets AI assistants and agents interact with
            your EvalFlow data programmatically via the Model Context Protocol.
  ...
  --header "Authorization: Basic {your-base64-token}"`}
        ...
        <Card className="p-4">
          ...
          <p className="text-primary mb-4 text-sm">
            The EvalFlow CLI provides terminal access to the full EvalFlow API.
            ...
            It uses the same API key pair as the EvalFlow SDKs.
          </p>
          <CodeBlock
            language="shell"
