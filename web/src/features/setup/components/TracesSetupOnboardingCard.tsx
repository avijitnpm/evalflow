...
export function TracesSetupOnboardingCard({
  ...
  return (
    <SplashScreen
      ...
      description="Get your API keys first, then ask your coding agent to add observability with EvalFlow to your application."
      ...
      steps={[
        {
          ...
          description:
            "Your application needs API keys to send traces to EvalFlow.",
          content: apiKeys ? (
            <ApiKeyDetailContent
              scope="project"
