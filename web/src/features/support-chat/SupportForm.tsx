...
export function SupportForm({
  ...
  return (
    <ConfirmationDialogController
      ...
      text="Please confirm that your issue has critical business impact. This means it severely impacts your use of EvalFlow in production, such as loss of production data, ingestion issues, or prompt fetching issues."
