...
const getPythonCode = (
  ...
  version: number,
  labels: string[],
) => `from langfuse import EvalFlow

# Initialize EvalFlow client
langfuse = EvalFlow()
...
// Initialize the EvalFlow client
  ...
  return (
    <Page
      headerProps={{
        ...
        help: {
          description:
            "You can use this prompt within your application through the EvalFlow SDKs and integrations. Refer to the documentation for more information.",
