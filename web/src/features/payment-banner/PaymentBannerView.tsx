    ...
    >
      <div className="flex min-w-0 flex-1 items-start gap-3 sm:items-center">
        ...
        <p className="min-w-0 text-sm wrap-break-word">
          ...
          {`We have problems collecting subscription payment for your organization '${organizationName}'. Please update your payment information to continue using EvalFlow.`}
        </p>
      </div>
      <Button
        size="sm"
